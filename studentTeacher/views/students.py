...
class StudentInterestsView(UpdateView):
    ...
    template_name = 'studentTeacher/students/interests_form.html'
...
class QuizListView(ListView):
    ...
    template_name = 'studentTeacher/students/quiz_list.html'
...
class QuizResultsView(View):
    template_name = 'studentTeacher/students/quiz_result.html'
...
class TakenQuizListView(ListView):
    ...
    template_name = 'studentTeacher/students/taken_quiz_list.html'
...
def take_quiz(request, pk):
    ...
    return render(request, 'studentTeacher/students/take_quiz_form.html', {
        'quiz': quiz,
        'question': question,
        'form': form,
        'progress': progress,
...
class StudentList(ListView):
    ...
    paginate_by = 36
    template_name = 'studentTeacher/students/student_list.html'
...
class StudentDetail(View):
    ...
    def get(self, request, **kwargs):
        ...
        return render(request,'studentTeacher/students/student_detail.html', 
